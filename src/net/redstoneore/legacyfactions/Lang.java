...
import net.redstoneore.legacyfactions.lang.LangState;
import net.redstoneore.legacyfactions.mixin.DebugMixin;

/**
 * The Lang enum has been relocated inside the lang package.<br>
 * This class has been left as is and will be removed in 1.6. 
 */
@Deprecated
public enum Lang {
	...
	public static void setFile(YamlConfiguration config) {
		DebugMixin.deprecatedWarning("net.redstoneore.legacyfactions.Lang#setFile(YamlConfiguration)", "net.redstoneore.legacyfactions.lang.Lang#setFile(YamlConfiguration)");
		LANG = config;
	...
	public String toString() {
		DebugMixin.deprecatedWarning("net.redstoneore.legacyfactions.Lang#toString", "net.redstoneore.legacyfactions.lang.Lang#toString");
	...
	public String format(Object... args) {
		DebugMixin.deprecatedWarning("net.redstoneore.legacyfactions.Lang#format", "net.redstoneore.legacyfactions.lang.Lang#format");
		return String.format(toString(), args);
	}
	
	public String getDefault() {
		DebugMixin.deprecatedWarning("net.redstoneore.legacyfactions.Lang#getDefault", "net.redstoneore.legacyfactions.lang.Lang#getDefault");
		return this.def;
	}
	
	public String getPath() {
		DebugMixin.deprecatedWarning("net.redstoneore.legacyfactions.Lang#getPath", "net.redstoneore.legacyfactions.lang.Lang#getPath");
		return this.path;
	}
	
	public LangBuilder getBuilder() {
		DebugMixin.deprecatedWarning("net.redstoneore.legacyfactions.Lang#getBuilder", "net.redstoneore.legacyfactions.lang.Lang#getBuilder");
		return new LangBuilder(this.toString());
	}
	
	public static void reload() {
		DebugMixin.deprecatedWarning("net.redstoneore.legacyfactions.Lang#reload", "net.redstoneore.legacyfactions.lang.Lang#reload");
	}
}
